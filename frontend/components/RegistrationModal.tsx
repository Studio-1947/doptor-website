            ...
            {isOpen && (
                <>
                    ...
                    <motion.div
                        ...
                        className="fixed left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-[calc(100%-2rem)] md:w-full max-w-lg bg-white/95 backdrop-blur-xl border border-white/20 rounded-3xl p-6 md:p-8 z-50 shadow-2xl overflow-hidden"
                    >
                        <button
                            onClick={onClose}
